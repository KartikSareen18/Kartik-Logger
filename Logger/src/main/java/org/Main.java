            ...
            case 'i':
                ...
                switch (sc.next().toLowerCase().charAt(0)){
                    case 's':
                        ...
                        logger.info(SimpleInterest.calculate(sc.nextDouble(), sc.nextDouble(), sc.nextDouble()));
                        break;

                    case 'c':
                        logger.info("Enter \"Principal Amount\" , \"Duration in Years\" and \"Rate of Interest\"...");
                        logger.info(CompoundInterest.calculate(sc.nextDouble(), sc.nextDouble(), sc.nextDouble()));
                        break;
